...
/**
 * All Free RTOS API and types related to the task creation.
 *
 * \defgroup Tasks Task Creation
 */
 ...
 *
 * \defgroup taskIDLE_PRIORITY taskIDLE_PRIORITY
 * \ingroup TaskUtils
 */
#define tskIDLE_PRIORITY			( ( UBaseType_t ) 0U )

/**
 * All Free RTOS API and macros related to the scheduler control.
 *
...
/**
 * All Free RTOS MPU specific API.
 *
...
/**
 * All Free RTOS API related to the control task.
 *
 ...
 *
 * \defgroup xTaskResumeFromISR xTaskResumeFromISR
 * \ingroup TaskCtrl
 */
...
/**
 * All Free RTOS API related to the utilities task.
 *
 ...
 * xTask was created.
 *
 * \defgroup uxTaskGetStackHighWaterMark uxTaskGetStackHighWaterMark
 * \ingroup TaskUtils
 */
...
constant. */
		 ...
		 * function.
		 *
		 * \defgroup vTaskSetApplicationTaskTag vTaskSetApplicationTaskTag
		 * \ingroup TaskUtils
		 */
		 ...
		 *
		 * \defgroup xTaskGetApplicationTaskTag xTaskGetApplicationTaskTag
		 * \ingroup TaskUtils
		 */
 ...
 *
 * \defgroup xTaskCallApplicationTaskHook xTaskCallApplicationTaskHook
 * \ingroup TaskUtils 
 */
...
/**
 * task.h
 * <pre> TaskHandle_t xTaskGetIdleTaskHandle( void ); </pre>
 *
 ...
 *
 * \defgroup xTaskGetIdleTaskHandle xTaskGetIdleTaskHandle
 * \ingroup TaskUtils 
 */
...
/**
 * task.h
 * <pre> UBaseType_t uxTaskGetSystemState( TaskStatus_t * const pxTaskStatusArray, const UBaseType_t uxArraySize, uint32_t * const pulTotalRunTime ); </pre>
 *
 ...
 *
 * \defgroup uxTaskGetSystemState uxTaskGetSystemState
 * \ingroup TaskUtils 
 */
...
/**
 * All Free RTOS API related to the task notification.
 *
 ...
 * for the port in use.
 *
 * \defgroup vTaskNotifyGiveFromISR vTaskNotifyGiveFromISR
 * \ingroup TaskNotifications
 */
